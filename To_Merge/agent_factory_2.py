...
from System.Core.universal_domain_registry import DOMAINS, SENTINEL_TYPES, get_all_agent_names, get_domain_count
from System.Core.agent_templates import TEMPLATES, get_template, format_template
...
if __name__ == "__main__":
    ...
    if args.stats:
        ...
        if len(parts) == 2:
            factory.spawn_agent(parts[0], parts[1], args.archetype)
        else:
